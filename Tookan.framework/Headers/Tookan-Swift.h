...
#ifndef TOOKAN_SWIFT_H
#define TOOKAN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tookan",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Tookan23CountdownAttributedText")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC6Tookan15LTMorphingLabel")
...
SWIFT_CLASS("_TtC6Tookan14CountdownLabel")
...
SWIFT_PROTOCOL("_TtP6Tookan22CountdownLabelDelegate_")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC6Tookan26FlexibleSteppedProgressBar")
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull selectOuterColorByGurji;
@property (nonatomic) NSInteger completedTillIndex;
@property (nonatomic) NSInteger selectedIndexAPI;
@property (nonatomic, strong) UIColor * _Nonnull currentSelectedCenterColor;
@property (nonatomic, strong) UIColor * _Null_unspecified currentSelectedTextColor;
@property (nonatomic, strong) UIColor * _Nonnull viewBackgroundColor;
@property (nonatomic, strong) UIColor * _Null_unspecified selectedOuterCircleStrokeColor;
@property (nonatomic, strong) UIColor * _Null_unspecified lastStateOuterCircleStrokeColor;
@property (nonatomic, strong) UIColor * _Null_unspecified lastStateCenterColor;
@property (nonatomic, strong) UIColor * _Null_unspecified centerLayerTextColor;
@property (nonatomic, strong) UIColor * _Nonnull centerLayerDarkBackgroundTextColor;
@property (nonatomic) BOOL useLastState;
/// The line height between points
@property (nonatomic) IBInspectable CGFloat lineHeight;
@property (nonatomic) CGFloat selectedOuterCircleLineWidth;
@property (nonatomic) CGFloat lastStateOuterCircleLineWidth;
...
@property (nonatomic, strong) UIFont * _Nullable stepTextFont;
/// The text color in the step points
@property (nonatomic, strong) UIColor * _Nullable stepTextColor;
/// The text font inside the circles
@property (nonatomic, strong) UIFont * _Nullable centerLayerTextFont;
...
@property (nonatomic, weak) id <FlexibleSteppedProgressBarDelegate> _Nullable delegate;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_PROTOCOL("_TtP6Tookan34FlexibleSteppedProgressBarDelegate_")
@protocol FlexibleSteppedProgressBarDelegate
@optional
...
SWIFT_CLASS("_TtC6Tookan15HamburgerButton")
...
SWIFT_CLASS("_TtC6Tookan13LTEmitterView")
...
@interface LTMorphingLabel (SWIFT_EXTENSION(Tookan))
...
SWIFT_PROTOCOL("_TtP6Tookan23LTMorphingLabelDelegate_")
@protocol LTMorphingLabelDelegate
@optional
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC6Tookan12MarqueeLabel")
...
SWIFT_CLASS("_TtC6Tookan8ScanView")
...
@interface ScanView (SWIFT_EXTENSION(Tookan)) <UIGestureRecognizerDelegate>
...
@interface ScanView (SWIFT_EXTENSION(Tookan)) <UITextViewDelegate>
